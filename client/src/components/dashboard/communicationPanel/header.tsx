import { AttachFileIcon, VideoCallIcon } from "../../../assets/icons";
import FeatureIcon from "../../../lib/images/featureIcon";
import ProfileIcon from "../../../lib/images/profileIcon";

export default function Header(props: { name: string; imgUrl: string }) {
  return (
    <div className="flex justify-between items-center p-2 border-b">
      <div className="flex justify-start items-center">
        <ProfileIcon uid="2" imgUrl={props.imgUrl} />
